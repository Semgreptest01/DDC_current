...
<table width="715" height="49" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td>
			<textarea rows="18" id="msg_out" class="msg_box_err" readonly><%= CollectionUtility.cnvrtStrngLnFrmVctr( msgBx ) %></textarea>
		</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	...
	<tr>
		<td class="err_msg">現在、この画面はサービス出来ません。</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
