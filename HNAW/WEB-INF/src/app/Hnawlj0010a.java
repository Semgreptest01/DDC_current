...
public class Hnawlj0010a extends common.ServletA
{
	private static final long	serialVersionUID = 1L;
	/**
	 * サーブレット名
	 */
	private static final	String	SRVLT_NM		= "Hnawlj0010a";
	/**
	 * DBAccess名
	 */
	 ...
	 * 通常JSP名
	 */
	private static final	String	NRML_JSP		= "Hnawlj0010aJ.jsp";
	/**
	 * 前JSP名
	 */
	...
	*/
									...
									DBAccess			argmntDba	) throws Exception
	{
		...
		if ( ServletUtility.isCancel( request ) ) {
			return Const.SRVLT_RSLT_BCK;
		} else {
			// HTTP-Paramの取得
			dba.setRqstPrmtr( request );
			if ( dba.setUsrNm( con ) ) {
				dba.setSlctLstDt( con );
			} else {
				return Const.SRVLT_RSLT_BCK;
			}
		}
